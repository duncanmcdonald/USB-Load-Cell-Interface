...
//!
//! @brief Atmel file. Watchdog low level driver definitions. See "Watchdog and reset sytem drivers module" module
//!
//! @version 1.8 at90usb128-demo-template-1_0_5 $Id: wdt_drv.h,v 1.8 2006/03/10 15:39:01 rletendu Exp $
//!
//! @todo
//! @bug
