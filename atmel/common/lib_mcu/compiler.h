...
//!
//! @brief Atmel file. Redefines dedicated IAR AVR keywords to ensure processing by GCC
//!
//! @version 1.13.2.30 aat90usb128-demo-template-1_0_5
//!
//! @todo
//! @bug
...
*----------------------------------------------------------------------------
* RELEASE:      at90usb128-demo-template-1_0_5
* FILE_REV:     1.13.2.30
*----------------------------------------------------------------------------
* PURPOSE:
...
typedef long                S32;
#if (defined __C51__)
typedef bit                 Bool;    // Shall be used with _MEMTYPE_BIT_ to optimize the memory.
#else
...
#if (defined __C51__)
#  define _MEMTYPE_BIT_              bdata  // Used for bit accesses
#  define _MEMTYPE_FAST_              data
#  define _MEMTYPE_MEDFAST_          idata
#  define _MEMTYPE_MEDSLOW_          pdata
#  define _MEMTYPE_SLOW_             xdata
#else
#  define _MEMTYPE_BIT_
#  define _MEMTYPE_FAST_
#  define _MEMTYPE_MEDFAST_
#  define _MEMTYPE_MEDSLOW_
#  define _MEMTYPE_SLOW_
#endif
