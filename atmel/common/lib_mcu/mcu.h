...
//!
//! @brief Atmel file. Predefined Special Function Registers (SFR) Addresses
//!
//! @version 1.6.6.9.2.21 at90usb128-demo-template-1_0_5
//!
//! @todo
//! @bug
...
SFR_B(MCUCR,  0x35)    /* MCU Control Register */  was 0x35
...
#define    CKLPCE   7
#define    CLKPCE   7 //for compatibility
#define    CKLPS3   3
#define    CKLPS2   2
#define    CKLPS1   1
#define    CKLPS0   0
